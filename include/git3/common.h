 ...
 */
GIT_EXTERN(int) git_libgit3_version(int *major, int *minor, int *rev);
 ...
 */
GIT_EXTERN(const char *) git_libgit3_prerelease(void);
 ...
 */
GIT_EXTERN(int) git_libgit3_features(void);
 ...
 */
GIT_EXTERN(const char *) git_libgit3_feature_backend(
 ...
 */
GIT_EXTERN(int) git_libgit3_opts(int option, ...);

/**
 * Build information items to query. This is the information type
 * passed to `git_libgit3_buildinfo` to get particular information
 ...
 */
GIT_EXTERN(const char *) git_libgit3_buildinfo(
