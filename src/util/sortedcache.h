 ...
 * in a GIT3_FLEX_ARRAY.
 */

typedef void (*git3_sortedcache_free_item_fn)(void *payload, void *item);
 ...
 *
 * Even though every sortedcache stores items with a GIT3_FLEX_ARRAY at
 ...
 *
 * @param out The allocated git3_sortedcache
 * @param item_path_offset Offset to the GIT3_FLEX_ARRAY item key in the
 ...
 */
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_new(
 ...
 */
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_copy(
	git3_sortedcache **out,
...
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_wlock(git3_sortedcache *sc);
 ...
 */
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_lockandload(
	git3_sortedcache *sc, git3_str *buf);
 ...
 */
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_clear(
	git3_sortedcache *sc, bool wlock);

/* Find and/or insert item, returning pointer to item data.
 * You should already be holding the write lock when you call this.
 */
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_upsert(
	void **out, git3_sortedcache *sc, const char *key);
...
GIT3_WARN_UNUSED_RESULT int git3_sortedcache_rlock(git3_sortedcache *sc);
...
/* Lookup index of item by key - returns GIT3_ENOTFOUND if not found */
