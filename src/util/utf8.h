 ...
 */
extern int git3_utf8_iterate(uint32_t *out, const char *str, size_t str_len);
 ...
 */
extern size_t git3_utf8_char_length(const char *str, size_t str_len);
 ...
 */
extern size_t git3_utf8_valid_buf_length(const char *str, size_t str_len);
