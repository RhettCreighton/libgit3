 ...
 * convenience function for `git3_utf8_to_16_with_len`.
 *
 ...
 * function for `git3_utf8_from_16_with_len`.
 *
 ...
 *         (not counting the NULL terminator), or < 0 for failure
 */
int git3_utf8_from_16_with_len(char *dest, size_t dest_size, const wchar_t *src, int src_len);
 ...
 *         (not counting the NULL terminator), or < 0 for failure
 */
int git3_utf8_to_16_alloc_with_len(
	wchar_t **dest,
	const char *src,
	int src_len);
 ...
 *         (not counting the NULL terminator), or < 0 for failure
 */
int git3_utf8_from_16_alloc_with_len(
	char **dest,
	const wchar_t *src,
	int src_len);
