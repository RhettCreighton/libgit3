...
extern const char *git3_config_escapes;
extern const char *git3_config_escaped;
...
#define GIT3_CONFIG_PARSER_INIT { NULL, GIT3_PARSE_CTX_INIT }

typedef int (*git3_config_parser_section_cb)(
...
typedef int (*git3_config_parser_variable_cb)(
	git3_config_parser *parser,
	const char *current_section,
	const char *var_name,
...
typedef int (*git3_config_parser_comment_cb)(
	git3_config_parser *parser,
	const char *line,
	size_t line_len,
	void *payload);

typedef int (*git3_config_parser_eof_cb)(
	git3_config_parser *parser,
	const char *current_section,
	void *payload);
