...
{
	const char *threads = git_libgit3_feature_backend(GIT_FEATURE_THREADS);
	const char *https = git_libgit3_feature_backend(GIT_FEATURE_HTTPS);
	const char *ssh = git_libgit3_feature_backend(GIT_FEATURE_SSH);
	const char *nsec = git_libgit3_feature_backend(GIT_FEATURE_NSEC);
	const char *http_parser = git_libgit3_feature_backend(GIT_FEATURE_HTTP_PARSER);
	const char *regex = git_libgit3_feature_backend(GIT_FEATURE_REGEX);
	const char *i18n = git_libgit3_feature_backend(GIT_FEATURE_I18N);
	const char *ntlm = git_libgit3_feature_backend(GIT_FEATURE_AUTH_NTLM);
	const char *negotiate = git_libgit3_feature_backend(GIT_FEATURE_AUTH_NEGOTIATE);
	const char *compression = git_libgit3_feature_backend(GIT_FEATURE_COMPRESSION);
	const char *sha1 = git_libgit3_feature_backend(GIT_FEATURE_SHA1);
	const char *sha256 = git_libgit3_feature_backend(GIT_FEATURE_SHA256);
