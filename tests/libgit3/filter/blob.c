...
void test_filter_blob__all_crlf(void)
{
	...
	cl_git_pass(git3_revparse_single(
		(git3_object **)&blob, g_repo, "a9a2e891")); /* all-crlf */
...
void test_filter_blob__ident(void)
{
	...
	cl_git_pass(git3_blob_create_from_workdir(&id, g_repo, "test.ident"));
	...
	cl_git_pass(git3_blob_filter(&buf, blob, "filter.bin", NULL));
	cl_assert_equal_s(
		"Some text\n$Id$\nGoes there\n", buf.ptr);

	cl_git_pass(git3_blob_filter(&buf, blob, "filter.identcrlf", NULL));
	cl_assert_equal_s(
		"Some text\r\n$Id: 3164f585d548ac68027d22b104f2d8100b2b6845 $\r\nGoes there\r\n", buf.ptr);

	cl_git_pass(git3_blob_filter(&buf, blob, "filter.identlf", NULL));
	cl_assert_equal_s(
		"Some text\n$Id: 3164f585d548ac68027d22b104f2d8100b2b6845 $\nGoes there\n", buf.ptr);
