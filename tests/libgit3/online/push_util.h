...
extern const git3_oid OID_ZERO;

/**
 * Macro for initializing git3_remote_callbacks to use test helpers that
 * record data in a record_callbacks_data instance.
 * @param data pointer to a record_callbacks_data instance
 */
#define RECORD_CALLBACKS_INIT(data) \
	{ GIT3_REMOTE_CALLBACKS_VERSION, NULL, NULL, cred_acquire_cb, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, data, NULL, record_update_refs_cb }
...
typedef struct {
	git3_vector updated_tips;
	git3_vector statuses;
...
/**
 * Callback for git3_remote_update_tips that records updates
 *
 * @param data (git3_vector *) of updated_tip instances
 */
...
/**
 * Callback for git3_remote_list that adds refspecs to vector
 *
 * @param head a ref on the remote
 * @param payload (git3_vector *) of git3_remote_head instances
 */
