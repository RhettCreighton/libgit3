...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "http://example.com/resource"));
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "example.com/resource"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/resource");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "example.com/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "80");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "8888888/"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "example.com:42"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "example.com");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata,
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "192.168.1.1/resource"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "192.168.1.1/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "192.168.1.1");
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "192.168.1.1:42"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "192.168.1.1");
	cl_assert_equal_s(conndata.port, "42");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "[fe80::dcad:beff:fe00:0001]/resource"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "[fe80::dcad:beff:fe00:0001]/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "fe80::dcad:beff:fe00:0001");
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "[fe80::dcad:beff:fe00:0001]:42"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "fe80::dcad:beff:fe00:0001");
	cl_assert_equal_s(conndata.port, "42");
	cl_assert_equal_s(conndata.path, "/");
...
void test_url_http__ipv6_invalid_addresses(void)
{
	...
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse_http(&conndata,
	...
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse_http(&conndata, "[fe8o::dcad:beff:fe00:0001]/resource"));
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "foo!bar://host:42/path/to/project?query_string=yes"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "GIT+SSH://host:42/path/to/project"));
	cl_assert_equal_s(conndata.scheme, "git+ssh");
}

void test_url_http__no_scheme_relative_path(void)
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "path"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse_http(&conndata, "libgit3@dev.azure.com/libgit3/test/_git/spaces%20in%20the%20name"));
	cl_assert_equal_s(conndata.scheme, "http");
