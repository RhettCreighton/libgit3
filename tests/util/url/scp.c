...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "example.com:/resource"));
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "example.com:/"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "22");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "git@example.com:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "22");
	cl_assert_equal_s(conndata.path, "/resource");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[example.com:42]:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "example.com");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[example.com:22]:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "22");
	cl_assert_equal_s(conndata.path, "/resource");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[git@example.com:42]:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "42");
	cl_assert_equal_s(conndata.path, "/resource");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "192.168.99.88:/resource/a/b/c"));
	cl_assert_equal_s(conndata.scheme, "ssh");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "git@192.168.99.88:/resource/a/b/c"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "192.168.99.88");
	cl_assert_equal_s(conndata.port, "22");
	cl_assert_equal_s(conndata.path, "/resource/a/b/c");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[192.168.99.88:1111]:/resource/a/b/c"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "192.168.99.88");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[git@192.168.99.88:1111]:/resource/a/b/c"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "192.168.99.88");
	cl_assert_equal_s(conndata.port, "1111");
	cl_assert_equal_s(conndata.path, "/resource/a/b/c");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[fe80::dcad:beff:fe00:0001]:/resource/foo"));
	cl_assert_equal_s(conndata.scheme, "ssh");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "git@[fe80::dcad:beff:fe00:0001]:/resource/foo"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "[fe80::dcad:beff:fe00:0001]");
	cl_assert_equal_s(conndata.port, "22");
	cl_assert_equal_s(conndata.path, "/resource/foo");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[[fe80::dcad:beff:fe00:0001]:99]:/resource/foo"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "[fe80::dcad:beff:fe00:0001]");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[git@[fe80::dcad:beff:fe00:0001]:99]:/resource/foo"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "[fe80::dcad:beff:fe00:0001]");
	cl_assert_equal_s(conndata.port, "99");
	cl_assert_equal_s(conndata.path, "/resource/foo");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[fe:22]:/resource/foo"));
	cl_assert_equal_s(conndata.scheme, "ssh");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "fe80::dcad:beff:fe00:0001]:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "[fe80::dcad:beff:fe00:0001]:42]:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "[fe80::dcad:beff:fe00:0001]");
	cl_assert_equal_s(conndata.port, "22");
...
{
	cl_git_pass(git3_net_url_parse_scp(&conndata, "git@[fe80::dcad:beff:fe00:0001]:42]:/resource"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "[fe80::dcad:beff:fe00:0001]");
	cl_assert_equal_s(conndata.port, "22");
	cl_assert_equal_s(conndata.path, "42]:/resource");
...
{
	/* Path is required */
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse_scp(&conndata,
		"example.com"));
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse_scp(&conndata,
		"example.com:"));
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse_scp(&conndata,
