...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://example.com/resource"));
	...
	cl_assert_equal_i(git3_net_url_is_default_port(&conndata), 1);
	cl_assert_equal_i(conndata.port_specified, 0);
}

void test_url_parse__hostname_root(void)
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://example.com/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "80");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://8888888/"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://example.com:42"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "example.com");
	...
	cl_assert_equal_p(conndata.query, NULL);
	cl_assert_equal_p(conndata.fragment, NULL);
	cl_assert_equal_i(git3_net_url_is_default_port(&conndata), 0);
	cl_assert_equal_i(conndata.port_specified, 1);
}

void test_url_parse__specified_default_port(void)
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://example.com:80/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "example.com");
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse(&conndata,
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://192.168.1.1/resource"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://192.168.1.1/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "192.168.1.1");
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://192.168.1.1:42"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "192.168.1.1");
	cl_assert_equal_s(conndata.port, "42");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://[fe80::dcad:beff:fe00:0001]/resource"));
	cl_assert_equal_s(conndata.scheme, "http");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://[fe80::dcad:beff:fe00:0001]/"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "fe80::dcad:beff:fe00:0001");
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://[fe80::dcad:beff:fe00:0001]:42"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_s(conndata.host, "fe80::dcad:beff:fe00:0001");
	cl_assert_equal_s(conndata.port, "42");
	cl_assert_equal_s(conndata.path, "/");
...
void test_url_parse__ipv6_invalid_addresses(void)
{
	...
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse(&conndata,
	...
	cl_git_fail_with(GIT3_EINVALIDSPEC, git3_net_url_parse(&conndata, "http://[fe8o::dcad:beff:fe00:0001]/resource"));
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "://example.com/resource"));
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "foo!bar://host:42/path/to/project?query_string=yes"));
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "GIT+SSH://host:42/path/to/project"));
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "mailto:foobar@example.com"));
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "path"));
	cl_assert_equal_p(conndata.scheme, NULL);
	cl_assert_equal_p(conndata.host, NULL);
	cl_assert_equal_p(conndata.port, NULL);
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "mailto:"));
	cl_assert_equal_s(conndata.scheme, "mailto");
	cl_assert_equal_p(conndata.host, NULL);
	cl_assert_equal_p(conndata.port, NULL);
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "http://"));
	cl_assert_equal_s(conndata.scheme, "http");
	cl_assert_equal_p(conndata.host, NULL);
	cl_assert_equal_s(conndata.port, "80");
	cl_assert_equal_s(conndata.path, "/");
...
{
	cl_git_fail(git3_net_url_parse(&conndata, "https://my.email.address@gmail.com@source.developers.google.com:4433/p/my-project/r/my-repository"));
}

void test_url_parse__ssh_from_terrible_google_rfc_violating_products(void)
{
	cl_git_pass(git3_net_url_parse(&conndata, "ssh://my.email.address@gmail.com@source.developers.google.com:2022/p/my-project/r/my-repository"));
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "ssh://my.email.address@gmail.com:seekret@source.developers.google.com:2022/p/my-project/r/my-repository"));
	cl_assert_equal_s(conndata.scheme, "ssh");
	cl_assert_equal_s(conndata.host, "source.developers.google.com");
	cl_assert_equal_s(conndata.port, "2022");
	cl_assert_equal_s(conndata.path, "/p/my-project/r/my-repository");
...
{
	cl_git_pass(git3_net_url_parse(&conndata, "https://libgit3@dev.azure.com/libgit3/test/_git/spaces%20in%20the%20name"));
	cl_assert_equal_s(conndata.scheme, "https");
	cl_assert_equal_s(conndata.host, "dev.azure.com");
	cl_assert_equal_s(conndata.port, "443");
	cl_assert_equal_s(conndata.path, "/libgit3/test/_git/spaces%20in%20the%20name");
	cl_assert_equal_s(conndata.username, "libgit3");
	cl_assert_equal_p(conndata.password, NULL);
	cl_assert_equal_i(git3_net_url_is_default_port(&conndata), 1);
	cl_assert_equal_i(conndata.port_specified, 0);
}
