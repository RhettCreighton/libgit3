...
static int sha256_file(unsigned char *out, const char *filename)
{
	...
	cl_git_pass(git3_hash_ctx_init(&ctx, GIT3_HASH_ALGORITHM_SHA256));
...
{
	unsigned char expected[GIT3_HASH_SHA256_SIZE] = {
		0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14,
		0x9a, 0xfb, 0xf4, 0xc8, 0x99, 0x6f, 0xb9, 0x24,
		0x27, 0xae, 0x41, 0xe4, 0x64, 0x9b, 0x93, 0x4c,
		0xa4, 0x95, 0x99, 0x1b, 0x78, 0x52, 0xb8, 0x55
	};
	unsigned char actual[GIT3_HASH_SHA256_SIZE];

	cl_git_pass(sha256_file(actual, FIXTURE_DIR "/empty"));
	cl_assert_equal_i(0, memcmp(expected, actual, GIT3_HASH_SHA256_SIZE));
}
