...
if(USE_AUTH_NEGOTIATE STREQUAL "gssframework")
	...
	list(APPEND LIBGIT3_SYSTEM_LIBS ${GSSFRAMEWORK_LIBRARIES})

	set(GIT3_AUTH_NEGOTIATE 1)
	set(GIT3_AUTH_NEGOTIATE_GSSFRAMEWORK 1)
...
elseif(USE_AUTH_NEGOTIATE STREQUAL "gssapi")
	...
	list(APPEND LIBGIT3_SYSTEM_LIBS ${GSSAPI_LIBRARIES})

	set(GIT3_AUTH_NEGOTIATE 1)
	set(GIT3_AUTH_NEGOTIATE_GSSAPI 1)
