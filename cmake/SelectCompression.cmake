...
if(NOT USE_COMPRESSION)
	...
	if(ZLIB_FOUND)
		set(GIT3_COMPRESSION_ZLIB 1)
	else()
		message(STATUS "zlib was not found; using bundled 3rd-party sources." )
		set(GIT3_COMPRESSION_BUILTIN 1)
	endif()
...
if(GIT3_COMPRESSION_ZLIB)
	list(APPEND LIBGIT3_SYSTEM_INCLUDES ${ZLIB_INCLUDE_DIRS})
	list(APPEND LIBGIT3_SYSTEM_LIBS ${ZLIB_LIBRARIES})
	if(APPLE OR CMAKE_SYSTEM_NAME MATCHES "FreeBSD")
		list(APPEND LIBGIT3_PC_LIBS "-lz")
	else()
		list(APPEND LIBGIT3_PC_REQUIRES "zlib")
	endif()
	add_feature_info("Compression" ON "using system zlib")
elseif(GIT3_COMPRESSION_BUILTIN)
	add_subdirectory("${PROJECT_SOURCE_DIR}/deps/zlib" "${PROJECT_BINARY_DIR}/deps/zlib")
	list(APPEND LIBGIT3_DEPENDENCY_INCLUDES "${PROJECT_SOURCE_DIR}/deps/zlib")
	list(APPEND LIBGIT3_DEPENDENCY_OBJECTS $<TARGET_OBJECTS:zlib>)
