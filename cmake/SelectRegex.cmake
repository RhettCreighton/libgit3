...
elseif(USE_REGEX STREQUAL "pcre2")
	...
	set(GIT3_REGEX_PCRE2 1)

	list(APPEND LIBGIT3_SYSTEM_INCLUDES ${PCRE2_INCLUDE_DIRS})
	list(APPEND LIBGIT3_SYSTEM_LIBS ${PCRE2_LIBRARIES})
	list(APPEND LIBGIT3_PC_REQUIRES "libpcre2-8")
elseif(USE_REGEX STREQUAL "pcre")
	add_feature_info("Regular expressions" ON "using system PCRE")
	set(GIT3_REGEX_PCRE 1)

	list(APPEND LIBGIT3_SYSTEM_INCLUDES ${PCRE_INCLUDE_DIRS})
	list(APPEND LIBGIT3_SYSTEM_LIBS ${PCRE_LIBRARIES})
	list(APPEND LIBGIT3_PC_REQUIRES "libpcre")
elseif(USE_REGEX STREQUAL "regcomp")
	add_feature_info("Regular expressions" ON "using system regcomp")
	set(GIT3_REGEX_REGCOMP 1)
elseif(USE_REGEX STREQUAL "builtin")
	add_feature_info("Regular expressions" ON "using bundled implementation")
	set(GIT3_REGEX_BUILTIN 1)

	add_subdirectory("${PROJECT_SOURCE_DIR}/deps/pcre" "${PROJECT_BINARY_DIR}/deps/pcre")
	list(APPEND LIBGIT3_DEPENDENCY_INCLUDES "${PROJECT_SOURCE_DIR}/deps/pcre")
	list(APPEND LIBGIT3_DEPENDENCY_OBJECTS $<TARGET_OBJECTS:pcre>)
else()
