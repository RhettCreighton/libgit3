...
if(USE_I18N)
	...
	list(APPEND LIBGIT3_SYSTEM_INCLUDES ${ICONV_INCLUDE_DIR})
	list(APPEND LIBGIT3_SYSTEM_LIBS ${ICONV_LIBRARIES})
	list(APPEND LIBGIT3_PC_LIBS ${ICONV_LIBRARIES})

        set(GIT3_I18N 1)
        set(GIT3_I18N_ICONV 1)
