...
if(USE_THREADS STREQUAL "pthreads")
	...
	list(APPEND LIBGIT3_SYSTEM_LIBS ${CMAKE_THREAD_LIBS_INIT})
	list(APPEND LIBGIT3_PC_LIBS ${CMAKE_THREAD_LIBS_INIT})

	set(GIT3_THREADS 1)
	set(GIT3_THREADS_PTHREADS 1)
